...
# Bot information
API_ID = environ.get('API_ID', '20447284')
if len(API_ID) == 0:
...
if len(API_HASH) == 0:
    ...
    exit()
BOT_TOKEN = environ.get('BOT_TOKEN', '8347903353:AAEBKMTqgIQjTCuis0HlJP0xAQXjqwgIt8M')
if len(BOT_TOKEN) == 0:
...
# Bot Admins
ADMINS = environ.get('ADMINS', '8452579484')
if len(ADMINS) == 0:
...
LOG_CHANNEL = environ.get('LOG_CHANNEL', '-1003156084590')
...
# MongoDB information
DATA_DATABASE_URL = environ.get('DATA_DATABASE_URL', "r622dio.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
BIN_CHANNEL = environ.get("BIN_CHANNEL", "-1003156084590")
if len(BIN_CHANNEL) == 0:
    logger.error('BIN_CHANNEL is missing, exiting now')
    exit()
else:
    BIN_CHANNEL = int(BIN_CHANNEL)
URL = environ.get("URL", "-1003156084590")
if len(URL) == 0:
